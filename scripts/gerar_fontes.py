...
# então instala automaticamente se faltar — funciona tanto rodando como .py
# quanto em notebook Jupyter/Databricks, sem precisar de %pip nem de reiniciar
...
try:
    ...
    print("openpyxl não encontrado — instalando automaticamente...")
...
def resolver_base() -> Path:
    ...
    Funciona:
    - via python scripts/gerar_fontes.py
    - em notebook
    - no Databricks Git Folder
    """
